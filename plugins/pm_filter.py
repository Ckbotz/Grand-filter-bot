...
from utils import get_size, is_subscribed, get_poster, search_gagala, temp, get_settings, save_group_settings, send_all, extract_tag, clean_filename
        ...
        btn = [
            [
                InlineKeyboardButton(
                   text=f"{get_size(file.file_size)}|{tag} {name}", callback_data=f'{pre}#{file.file_id}'
                ),
            ]
            for file in files
        ]
