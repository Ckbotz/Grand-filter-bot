...
# Supports one or more space separated channel ids, e.g. "-1001234567890 -1009876543210"
AUTH_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in auth_channel.split()] if auth_channel else None
